...
let secondNumber = finances[1][1];

let profitOrLoss = secondNumber - firstNumber

console.log(profitOrLoss)

for (let index = 0; index < finances.length; index++) {
  console.log(profitOrLoss[i])
  
}*/

function profitOrLoss (firstNumber,secondNumber){
  var difference = secondNumber - firstNumber
  console.log(difference)
}

profitOrLoss(finances[0][1], finances[1][1])
